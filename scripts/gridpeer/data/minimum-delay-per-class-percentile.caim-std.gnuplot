...
plot 'minimum-delay-per-class-percentile.data' using 2:3 i 0 with lines lt 1 lc rgb "red" title "50% LU", \
     'minimum-delay-per-class-percentile.data' using 2:3 i 1 with lines lt 2 lc rgb "red" title "80% LU", \
     'minimum-delay-per-class-percentile.data' using 2:3 i 2 with lines lt 3 lc rgb "red" title "95% LU", \
     'minimum-delay-per-class-percentile.data' using 2:4 i 0 with lines lt 1 lc rgb "blue" title "50% HU", \
     'minimum-delay-per-class-percentile.data' using 2:4 i 1 with lines lt 2 lc rgb "blue" title "80% HU", \
     'minimum-delay-per-class-percentile.data' using 2:4 i 2 with lines lt 3 lc rgb "blue" title "95% HU"
#, \
