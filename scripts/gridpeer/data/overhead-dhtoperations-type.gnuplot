#set logscale y
unset xlabel # "DHT/DT operation"
set ylabel "DHT/DT operations"
...
set output 'overhead-dhtoperations-type.eps'
...
plot 'overhead-dhtoperations-type.data' using 2:xtic(1) ti col fs pattern 0
#, \
